...
SECRET_KEY = 'django-insecure-#%tjl68anxu)vsge+&^v=ob&7y2205o65no&4@7zm)y%ox49#g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'rbac_app' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'rbac_app' / 'static',  # Add your static files folder here
]
